...
<object
    ...
    WIDTH = "100%" HEIGHT = "100%" NAME = "menu" ALIGN = "center" VSPACE = "0" HSPACE = "0" >
    <PARAM NAME = CODE VALUE = "client.essp.common.security.role.VwRoleMenuApplet.class" >
	...
	<embed
            ...
            CODE = "client.essp.common.security.role.VwRoleMenuApplet.class" \
