...
<%
   ...
   String pathEnd = "/projectpre/deptcode/codeQuery/DeptQueryDetail.jsp";
    ...
    <tiles:insert page="/layout/head.jsp">
      ...
      <script type="text/javascript" language="javascript">
       ...
       function onRefreshData(){
          projectCodeApply.location="<%=contextPath%>/projectpre/deptcode/codeQuery/DeptCodeQuery.jsp";
       }
         ...
         <td >
           <html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
             <html:tabtitles selectedindex="1">
                <%--THE 1st tab--%>
                  <html:tabtitle width="120"><span class="tabs_title"><bean:message bundle="projectpre" key="deptCode.deptQuery"/></span></html:tabtitle>
             </html:tabtitles>
