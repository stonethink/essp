...
<%
   ...
   String listPathEnd = "/projectpre/deptcode/codeQuery/ShowData.jsp";
   
   actionSrc_queryData=contextPath+"/dept/query/deptQueryData.do";
  ...
  <head>
     ...
     <script type="text/javascript" language="javascript">
       ...
       function onRefreshData(){
          queryData.location="<%=contextPath%>/projectpre/deptcode/codeQuery/QueryData.jsp";
