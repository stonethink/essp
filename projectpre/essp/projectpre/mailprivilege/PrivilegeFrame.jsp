...
<%String actionSrc_PrivilegeDetail = "";
			actionSrc_PrivilegeDetail = contextPath
					+ "/projectpre/mailprivilege/PrivilegeDetail.jsp";%>
...
<html>
    ...
    function onRefreshData() {
        ...
        PrivilegeDetail.location="<%=contextPath%>/projectpre/mailprivilege/PrivilegeDetail.jsp";
        onTabChange();
    }
					...
					<html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
						<html:tabtitles selectedindex="1">
							...
							<html:tabtitle width="120">
								<span class="tabs_title"><bean:message bundle="projectpre" key="projectCode.MailPrivilege.user"/></span>
							</html:tabtitle>
						</html:tabtitles>
						<html:tabbuttons>
							<div id="btnPanel">
						...
						<html:tabcontents>
							...
							<html:tabcontent>
								<html:outborder width="100%" height="100%" outLine="no">
									<IFRAME id="PrivilegeDetail" name="PrivilegeDetail" SRC="<%=actionSrc_PrivilegeDetail%>" tabindex="1" width="100%" height="100%" frameborder="0" MARGINWIDTH="0" MARGINHEIGHT="0" SCROLLING="no">
									</IFRAME>
								</html:outborder>
							</html:tabcontent>
						</html:tabcontents>
