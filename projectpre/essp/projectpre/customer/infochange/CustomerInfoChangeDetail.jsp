...
<%
   ...
   String actionSrc_changeData="";

   
  actionSrc_changeData=contextPath+"/projectpre/customer/infochange/ChangeData.jsp";
     ...
     <script type="text/javascript" language="javascript">
       ...
       function onTabChange(){
         try {
              ...
              changeList.disableBtn();
             }catch(e){
             }
       }
       
       function onAddData(){
         changeList.onAddData();
       }
       
       function onDeleteData(){
         changeList.onDeleteData();
       }
       ...
       document.all.submitBtn.disabled=true;
         changeData.location="<%=contextPath%>/projectpre/Blank.jsp";
       }else{
          changeData.location="<%=contextPath%>/customer/change/displayCustApp.do?rid="+rid;
       }
         onTabChange();
      }
    ...
    <table cellspacing="0" cellpadding="1" height="100%" width="100%">
       <tr height="28%" >
		 <td class="wind">
		    <iframe 
				id="changeList" 
				src="<%=contextPath%>/customer/change/listAllCustApp.do" 
				scrolling="yes" 
         ...
         <td>
           <html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
             <html:tabtitles selectedindex="1">
                <%--THE 1st tab--%>
                  <html:tabtitle width="100"><span class="tabs_title"><bean:message bundle="projectpre" key="customer.CustomerInfoChangeDetail.cardTitle.ChangeData"/></span></html:tabtitle>
