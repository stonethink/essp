...
<%
   ...
   actionSrc_projectCodeApply=contextPath+"/project/edit/previewProjectEdit.do";
%>
...
<html>
  <head>
     ...
     <script type="text/javascript" language="javascript">
       ...
       function initButton(){
         addTabButtonByIndex(tabDetail,1,"selectBtn","<bean:message bundle="application"  key="global.button.select"/>","onSelectData()");
		 addTabButtonByIndex(tabDetail,1,"saveBtn","<bean:message bundle="application"  key="global.button.save"/>","onSaveData()");
		 addTabButtonByIndex(tabDetail,1,"reopenBtn","<bean:message bundle="application"  key="global.button.reOpen"/>","onReopenData()");
       }
       ...
       function onTabChange(){
         try {
              ...
              reopenBtn.style.width="100px";
             }catch(e){
             }
       }
       function onSelectData(){
         invokeSingleMethod("onSelectData",'',tabMap);
       }
       function onSaveData(){
         invokeSingleMethod("onSaveData",'',tabMap);
       }
       function onReopenData() {
       	 invokeSingleMethod("onReopenData",'',tabMap);
       }
       ...
       function onRefreshData(){
          projectCodeApply.location="<%=contextPath%>/project/edit/previewProjectEdit.do";
       }
                ...
                <%--THE 1st tab--%>
                  <html:tabtitle width="110">
                     <span class="tabs_title">
                       <bean:message bundle="projectpre"  key="projectCode.ProjectCodeEdit.cardTitle.ProjectEdit"/>
                     </span>
                  </html:tabtitle>
             </html:tabtitles>
