...
<html>
    ...
    function onRefreshData(code) {
       ...
       if(code==""||code==null){
          ...
          bdCodeGeneral.location="<%=contextPath%>/projectpre/Blank.jsp";
          
       }else{
        //alert("<%=contextPath%>/project/maintenance/previewBdCode.do?code="+code);
        bdCodeGeneral.location= "<%=contextPath%>/project/maintenance/previewBdCode.do?code="+code;
        }
        onTabChange();
    }
		...
		<TABLE width="100%" height="100%" CELLPADDING="1" CELLSPACING="0" BORDER="0" >
			<tr height="40%" >
				<td class="wind">
					...
					<iframe 
					id="bdCodeList" 
					src="<%=contextPath%>/project/maintenance/listAllBdCode.do" 
					scrolling="yes" 
