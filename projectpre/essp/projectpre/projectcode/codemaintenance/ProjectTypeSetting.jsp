...
<html>
    ...
    function initMap() {
		...
		tabMap2.put("1","projectTypeGeneral");
    }
    function onAddData(){
      projectTypeList.onAddData();
    }
    function onDelData(){
      projectTypeList.onDeleteData();
    }
    function onSaveData() {
       // invokeSingleMethod("onSaveData",'',tabMap2);
        areaProjectGeneral.onSaveData();
	}
    ...
    function onRefreshData(code) {
		...
		if(code==""||code==null){
          ...
          areaProjectGeneral.location="<%=contextPath%>/projectpre/Blank.jsp";
       }else{
		areaProjectGeneral.location= "<%=contextPath%>/codemaintenance/previewProjectType.do?code="+code;
		}
		...
		<TABLE width="100%" height="100%" CELLPADDING="1" CELLSPACING="0" BORDER="0" >
			<tr height="40%" >
				<td class="wind">
					...
					<iframe 
					id="projectTypeList" 
					src="<%=contextPath%>/codemaintenance/listProjectType.do" 
					scrolling="yes" 
						...
						<html:tabcontents>
							...
							<html:tabcontent styleClass="wind">
								<html:outborder width="100%" height="99%">
									<IFRAME 
									    id="areaProjectGeneral" 
									    name="areaProjectGeneral" 
									    SRC="" 
