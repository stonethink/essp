...
<table class="OraTable" summary="">
  ...
  <tbody>
    ...
    <tr id="workplan_tr" class="oracletdone">
      <td id="Account" class="cellText" width="30%"><bean:write name="exception" property="errorCode" /></td>
      <td id="Activity" class="cellText" width="70%"><bean:message name="exception" property="errorCode" bundle="error"/></td>
    </tr>
    
    </logic:present>
    <tr>
      <td colspan="2" align="right"><INPUT type="button" value="<bean:message key="global.button.back" bundle="application"/>" onclick="history.back();"></td>
    </tr>
  </tbody>
</table>
</BODY>
