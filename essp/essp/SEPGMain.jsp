...
<frameset name="content" frameborder="no" border="0" framespacing="0" cols="200,*" class="table_border">
  <frame src="left.jsp?SubSystem=M600000000" name="left" scrolling="no" marginwidth="0" marginheight="0"   >
  <frame src="pms/sepg.jsp" name="main" scrolling="no" marginwidth="2" marginheight="2">
</frameset>
<noframes></noframes>
