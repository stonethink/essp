...
<html>
    ...
    function onRefreshData(roleId) {
        ...
        UserList.location="<%=contextPath%>/security/listRoleUser.do?roleId="+roleId;
        onTabChange();
    }
	...
	<iframe
     ...
     <html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
						<html:tabtitles selectedindex="1">
							...
							<%--THE 2st tab--%>
							<html:tabtitle width="120">
								<span class="tabs_title"><bean:message bundle="application"  key="UserAssignRoles.AssignAuthorityMaintenance.tabtitle"/></span>
							</html:tabtitle>
						</html:tabtitles>
						<html:tabbuttons>
							<div id="btnPanel">
						...
						<html:tabcontents>
							...
							<html:tabcontent styleClass="wind">
								<html:outborder width="100%" height="230">
									<IFRAME
									    id="RoleGeneral"
									    name="RoleGeneral"
									    SRC=""
