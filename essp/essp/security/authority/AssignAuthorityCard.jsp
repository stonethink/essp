...
<%
  ...
  String actionSrc_UserRoleList = "";
  actionSrc_UserRoleList = contextPath
					+ "/security/authority/UserRoleList.jsp";
%>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
	<head>
	    <title>AssignAuthorityCard</title>
	...
	<script language="JavaScript" type="text/javascript">
        ...
        //    function onDelData() {
          ...
          function onRefreshData(LoginId,Domain) {

            //var url="<%=contextPath%>/security/UserRoleList.do?LoginId="+LoginId;
            UserRoleList.location="<%=contextPath%>/security/UserRoleList.do?LoginId="+LoginId+"&Domain="+Domain;
            onTabChange();
          }
	...
	<iframe
					id="UserList"
					src="<%=contextPath%>/security/authority/UserList.jsp"
					scrolling="yes"
     ...
     <html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
						<html:tabtitles selectedindex="1">
							...
							<html:tabtitle width="120">
								<span class="tabs_title"><bean:message bundle="application" key="UserAssignRoles.AssignAuthorityCard.tabtitle"/></span>
							</html:tabtitle>
						</html:tabtitles>
						<html:tabbuttons>
							<div id="btnPanel">
							...
							<html:tabcontent styleClass="wind">
								<html:outborder width="100%" height="99%">
									<IFRAME
									    id="UserRoleList"
									    name="UserRoleList"
									    SRC="<%=contextPath%>/security/authority/UserRoleList.jsp"
