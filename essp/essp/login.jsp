...
<html:form name="mains" action="login.do" >
    	...
    	<tr align="center">
      		...
      		<td width="190"  class="list_desc">
        		<html:text beanName="" name="loginId" fieldtype="text" next="passwd" styleId="loginID" onkeyup="loginIdChanged(this)"/>
      		</td>
    	...
    	<tr align="center">
          ...
          <html:password name="password" next="domain" styleId="passwd"  onkeydown="doLogin();"/>                  </td>
