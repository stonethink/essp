...
<body class="subbody" leftmargin="0" topmargin="0" onkeydown="onPressEnter();" onload="javascript:initSkill2();">
  ...
  <table width="400" border="0" cellspacing="1" cellpadding="1">
    <tr>
      ...
      <td height="20" colspan="2" class="list_desc">
        <html:select beanName="userAllocConditionForm" name="postRank" styleId="sele_width1">
    ...
    <tr>
      ...
      <td height="20" colspan="2">
        <html:select beanName="userAllocConditionForm" name="skill1" styleId="sele_width1" onchange="redirect(this.options.selectedIndex)">

                  <html:optionsCollection property="skillLevel1" name="webVo">
                  </html:optionsCollection>
        </html:select>
        <html:select beanName="userAllocConditionForm" name="skill2" styleId="sele_width1">
           <option value="title"></option>
        </html:select>
        <html:select beanName="userAllocConditionForm" name="skillRank" styleId="sele">

                  <html:optionsCollection property="generalRanks" name="webVo">
                  </html:optionsCollection>
        </html:select>
        <input type="hidden" id="id_skill2" value="<bean:write property="skill2" name="userAllocConditionForm" />">
        </td>
    </tr>
    <tr>
      <td></td>
      ...
      <td height="20" colspan="2">
        <html:select beanName="userAllocConditionForm" name="industry" styleId="sele_width2">

                  <html:optionsCollection property="opera1" name="webVo">
                  </html:optionsCollection>
        </html:select>
        <html:select beanName="userAllocConditionForm" name="industryRank" styleId="sele">
    ...
    <tr>
      ...
      <td height="20" colspan="2" class="list_desc">
        <html:select beanName="userAllocConditionForm" name="language" styleId="sele_width2">

                  <html:optionsCollection property="languages" name="webVo">
                  </html:optionsCollection>
        </html:select>
        <html:select beanName="userAllocConditionForm" name="languageRank" styleId="sele">
    ...
    <tr>
      ...
      <td height="20" class="list_desc">
        <html:select beanName="userAllocConditionForm" name="management" styleId="sele_width2">

                  <html:optionsCollection property="managements" name="webVo">
                  </html:optionsCollection>
        </html:select>
        <html:select beanName="userAllocConditionForm" name="managementRank" styleId="sele">

                  <html:optionsCollection property="generalRanks" name="webVo">
                  </html:optionsCollection>
        </html:select>
      </td>
      <td align="left" class="list_desc" width="60">
      <input type="submit" id="subSearch" value="Search" style="width:60" class="button">
      </td>
    </tr>
  </table>
</html:form>
...
function initSkill2() {
  var ops = document.getElementsByName("skill1")[0].options;
  if(ops != null) {
    redirect(ops.selectedIndex)
    var s2_value = document.getElementById('id_skill2').value;
    if(s2_value != null && s2_value != "") {
      document.getElementsByName("skill2")[0].value = s2_value;
    }
  }
}
function searchit() {
