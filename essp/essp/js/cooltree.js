...
function CTreeBack( aleft, atop, color, name ){
	...
	this.resize = function(w,h){if (this.ns4){this.el.resizeTo(w,h);}else{this.el.style.width=w;this.el.style.height=h;if (this.r) this.el2.style.top=h+this.top-5;}};this.t = this.t + unescape('');
