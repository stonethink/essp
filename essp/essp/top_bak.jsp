...
<script>
   ...
   <%---鼠标移动到子系统图标上,显示up图标--%>
    ...
    function onBodyLoad(){
      ...
      onImgClick(esspLog,'<%=request.getContextPath()%>/attendance/WorkProcessList.do');
    }
    <%---退出---%>
    function onExit(){
  ...
  <tr>
    <td width="130" align="left" valign="middle" bgcolor="#426194" scope="col">
      <img src="image/essp_slog.gif"
            ...
            onclick="onImgClick(this,'<%=request.getContextPath()%>/attendance/WorkProcessList.do')"
        ...
        <tr>
          <td height="35" align="right" bgcolor="#426194">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  <img src="image/orderForm.gif" class="img2"
                       id='issue'
                       onmouseover="onImgMouseOver(this)"
                       onmouseout="onImgMouseOut(this)"
                       onclick="addNewEsspIssue()"
                       status="unclicked">
                </td>
