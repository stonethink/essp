...
<script>
   ...
   function initMap(){
     ...
     imgMap.put("about","image/About.gif");
     imgUpMap.put("about","image/About_On.gif");
     imgDownMap.put("about","image/About_Down.gif");
   }
   ...
   <%---鼠标移动到子系统图标上,显示up图标--%>
    ...
    function onAbout(){
      window.showModelessDialog('<%=request.getContextPath()%>/about.jsp',"","dialogHeight:240px;dialogWidth:400px;");
    }
  ...
  <tr>
    <td width="130" align="left" valign="middle" bgcolor="#426194" scope="col">
      <img src="image/essp_slog.gif"
            ...
            id="essp" status="unclicked" style="cursor:pointer"/>
    </td>
             ...
             <logic:iterate id="sub" name="menu" property="subSystem">
               <td style="width:31px">
                 <img src='<bean:write name="sub" property="root.icon" />'
                       ...
                       class="SubsysImg"
                       alt="<bean:message bundle="application" name="sub" property="root.description"/>"
                       onmouseover="onImgMouseOver(this)"
                       onmouseout="onImgMouseOut(this)"
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
               <td height="1" width="4">                </td>
                <td>
                  <img src="image/About.gif" class="img2"
                       id="about"
                       alt="<bean:message bundle="application" key="Function.about.icon.tooltip" />"
                       onmouseover="onImgMouseOver(this)"
                       onmouseout="onImgMouseOut(this)"
                       onclick="onAbout()"
                       status="unclicked" 
                ...
                <td>
                  <img src="image/attorney.gif" class="img2"
                       id="agent"
                       alt="<bean:message bundle="application" key="Function.agent.icon.tooltip" />"
                       onmouseover="onImgMouseOver(this)"
                       onmouseout="onImgMouseOut(this)"
                       onclick="onAgent()"
                       status="unclicked"
                ...
                <td>
                  <img src="image/exit.gif" class="img2"
                    id="exit"
                    alt="<bean:message bundle="application" key="Function.exit.icon.tooltip" />"
                    onmouseover="onImgMouseOver(this)"
                    onmouseout="onImgMouseOut(this)"
                    onclick="onExit();"
                    status="unclicked"
