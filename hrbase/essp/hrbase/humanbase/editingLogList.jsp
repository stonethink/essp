...
<tiles:insert page="/layout/head.jsp">
  <tiles:put name="title" value="Editing Log List"/>
    ...
    try{
        ...
        if(rowObj != null && rid != null) {
        	...
        	if(rowObj.canUpdate != null && rowObj.canUpdate == "true") {
        		if(rowObj.canEdit != null && rowObj.canEdit == "true") {
...
function editHumanBaseLog(){
  ...
  var topPos=(screen.height-350)/2;
...
<center>
    ...
    <html:tabtitles>
        <html:tabtitle selected="true" width="90">
            <center><a class="tabs_title"><bean:message bundle="hrbase" key="hrbase.humanBase.btn.editLog"/></a></center>
        </html:tabtitle>
    </html:tabtitles>
    <%-- card buttons--%>
    <html:tabbuttons>
    ...
    <html:outborder height="80%" width="765">
      <html:table styleId="tableStyle">
        ...
        <html:tablebody styleId="tableDataStyle" height="300" id="searchTable">
          ...
          <bean:define id="canEdit" name="wv" property="canEdit" />
          <%
                String selfProperty = "rid=" + rid + " canUpdate=" + canUpdate + " canEdit=" + canEdit;
          %>
