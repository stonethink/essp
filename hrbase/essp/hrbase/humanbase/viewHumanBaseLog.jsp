...
<html>
	<head>
		<tiles:insert page="/layout/head.jsp">
			<tiles:put name="title" value="View Human Base Log Info" />
	...
	<body bgcolor="#ffffff" onload="this.focus();">
		<center class="form_title">
			<bean:message bundle="hrbase" key="hrbase.humanBase.title.viewLog"/>
		</center>
		<center>
			<html:form id="viewForm" action="/hrbase/humanbase/viewHumanBase" method="POST">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="20">&nbsp;</td>
						<td width="60" class="list_range">
							<bean:message bundle="hrbase" key="hrbase.humanBase.operation"/>
						</td>
						<td>
							<bean:write name="webVo" property="operation"/>
						</td>
						<td width="20">&nbsp;</td>
						<td width="60" class="list_range">
							<bean:message bundle="hrbase" key="hrbase.humanBase.status"/>
						</td>
						<td>
							<bean:write name="webVo" property="status"/>
						</td>
					</tr>
