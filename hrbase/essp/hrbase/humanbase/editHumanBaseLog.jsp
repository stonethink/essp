...
<html>
	<head>
		<tiles:insert page="/layout/head.jsp">
			<tiles:put name="title" value="Edit Human Base Log Info" />
	...
	<body bgcolor="#ffffff" onload="this.focus();">
		...
		<center>
			<html:form id="editForm" action="/hrbase/humanbase/editHumanBaseLog" method="POST">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr height="20">
						<td height="20">
						<html:hidden name="rid" property="rid" beanName="webVo" />
						<html:hidden name="baseRid" property="baseRid" beanName="webVo" />
						<html:hidden name="status" property="status" beanName="webVo" />
						<html:hidden name="operation" property="operation" beanName="webVo" />
						</td>
					</tr>
					<tr>
						<td width="20"></td>
