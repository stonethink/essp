...
//用于查人
 ...
 <html:form id="AfQueryData" action="/dept/addDept" method="post" onsubmit="return onClickSubmit(this)" >
 <table align="center"><tr align="center"><td align="center" class="list_range" width="150"><strong><bean:message bundle="hrbase" key="hrbase.dept.deptadd"/></strong></tr><tr height="20"><td></td></tr></table>
 <table width="750" order="0" style="padding-left:8px">
  ...
  <tr>
    ...
    <td class="list_range" >
    <html:text styleId="input_common1" name="unitCode"  beanName="webVo" req="true" fieldtype="text" readonly="false"  maxlength="10"/>
	</td>
