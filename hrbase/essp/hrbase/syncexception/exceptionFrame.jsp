...
<%
  ...
  actionSrc_exceptionDetail=contextPath+"/hrbase/syncexception/exceptionDetail.jsp";
...
<html>
  <head>
    ...
    function initButton() {
      addTabButtonByIndex(tabDetail,1,"confirmBtn","<bean:message bundle="hrbase" key="hrbase.syncexception.carryForward"/>","onConfirmData()");   
      addTabButtonByIndex(tabDetail,1,"cancelBtn","<bean:message bundle="hrbase" key="hrbase.syncexception.cancel"/>","onCancelData()");
    }
	</script>
  </head>
  <body   BOTTOMMARGIN="0">
...
<html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%" >
	<html:tabtitles  selectedindex="1"  >
         <%--THE 1st tab--%>
         <html:tabtitle width="120"><span class="tabs_title"><bean:message bundle="hrbase" key="hrbase.syncexception.handleCarryForward"/></span></html:tabtitle>
    </html:tabtitles>
    <html:tabbuttons>
    	<div id="btnPanel">
    	</div>
