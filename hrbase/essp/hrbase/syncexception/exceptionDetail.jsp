...
<html>
    ...
    function onRefreshData(rid) {
       //alert(rid);
       if(rid==null || rid==""){
          exceptionGeneral.location="<%=contextPath%>/hrbase/Blank.jsp";
       }else{
        //alert("<%=contextPath%>/project/maintenance/previewBdCode.do?code="+rid);
          exceptionGeneral.location= "<%=contextPath%>/syncexception/previewException.do?rid="+rid;
        }
    }
		...
		<TABLE width="100%" height="100%" CELLPADDING="1" CELLSPACING="0" BORDER="0" >
			<tr height="40%" >
				<td class="wind">
					...
					<iframe 
					id="exceptionList" 
					src="<%=contextPath%>/syncexception/listException.do" 
					scrolling="auto" 
