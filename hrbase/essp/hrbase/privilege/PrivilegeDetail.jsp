...
<%
  ...
  actionSrc_PrivilegeList = contextPath
					+ "/hrbase/privilege/SitePrivilegeList.jsp";
%>
...
<html>
	...
	<script language="JavaScript" type="text/javascript">
        ...
        function onAddData(){
          ...
          try{
            if(LoginId == null){
             PrivilegeList.location="<%=contextPath%>/hrbase/Blank.jsp";
            }else{
             PrivilegeList.location="<%=contextPath%>/privilege/privilegeSiteList.do?LoginId="+LoginId+"&loginName="+loginName+"&domain="+domain;
            }
            onTabChange();
            }catch(e){}
          }
	...
	<iframe
		id="UserList"
		src="<%=contextPath%>/privilege/initUserList.do"
		scrolling="auto"
     ...
     <html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
						<html:tabtitles selectedindex="1">
							...
							<html:tabtitle width="120">
								<span class="tabs_title"><bean:message bundle="hrbase" key="hrbase.privilege.siteprivilege"/></span>
							</html:tabtitle>
						</html:tabtitles>
						<html:tabbuttons>
							<div id="btnPanel">
