...
<%
   ...
   actionSrc_PrivilegeDetail=contextPath+"/hrbase/privilege/PrivilegeDetail.jsp";
%>
...
<html>
  <head>
    ...
    function onRefreshData() {
        ...
        PrivilegeDetail.location="<%=contextPath%>/hrbase/privilege/PrivilegeDetail.jsp";
        onTabChange();
    }
...
<html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%" >
	<html:tabtitles  selectedindex="1">
         <%--THE 1st tab--%>
         <html:tabtitle width="120"><span class="tabs_title"><bean:message bundle="hrbase" key="hrbase.privilege.user"/></span></html:tabtitle>
       </html:tabtitles>
    <html:tabbuttons>
    	<div id="btnPanel">
    	</div>
