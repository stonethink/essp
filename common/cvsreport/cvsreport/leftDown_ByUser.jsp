...
<%
    ...
    for (Iterator iter = reportDate.getRoot().users.entrySet().iterator(); iter.hasNext(); ) {
      Map.Entry item = (Map.Entry)iter.next();
      String userName = (String)item.getKey();

%>

	&nbsp;&nbsp;<a href="user.jsp?userName=<%=userName%>"><%=userName%></a>
