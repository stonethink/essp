...
public class HtmlBuilder {
    ...
    public HtmlBuilder selfproperty(String selfproperty) {
       if (StringUtils.isNotBlank(selfproperty)) {
           write(" selfproperty=\"").write(selfproperty).write("\" ");
       }
    ...
    * <p>The onclick attribute [onclick=].</p>
    */
   public HtmlBuilder ondbclick(String ondbclick) {
       if (StringUtils.isNotBlank(ondbclick)) {
           write(" ondbclick=\"").write(ondbclick).write("\" ");
       }
