...
public class RowBuilder {
    ...
    public void selfproperty(){
        String selfproperty = row.getSelfproperty();
        html.selfproperty(selfproperty);
    }
    public void onclick() {
        String onclick = row.getOnclick();
        //Row auto call function onChangeBackgroundColor()
        if (StringUtils.isNotBlank(onclick)) {
                onclick="onChangeBackgroundColor(this);"+onclick;
        }else{
                onclick="onChangeBackgroundColor(this);";
        }
        html.onclick(onclick);
    }

    public void ondbclick() {
       String ondbclick = row.getOndbclick();
       html.ondbclick(ondbclick);
   }
