...
public class DependencyTagHandler implements TagHandler, ParsingListener {
    ...
    public DependencyTagHandler(GanttProject project){
        myTaskManager=project.getTaskManager();
        myUIFacade=(UIFacade)project;
    }
    ...
    public GanttDependStructure createGanttDependStructure(int a,int b){
                return new GanttDependStructure(a,b);
    }
    //此类原为私有类
