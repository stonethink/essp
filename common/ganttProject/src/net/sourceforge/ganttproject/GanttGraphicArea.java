...
import net.sourceforge.ganttproject.task.dependency.constraint.
...
//            Cursor.E_RESIZE_CURSOR);
    ...
    private static final Cursor CHANGE_PROGRESS_CURSOR = new Cursor(
        Cursor.HAND_CURSOR);
    ;
...
//    public GanttCalendar date;
    ...
    //源为Final对象，现在需要改变，所以去掉final属性
    private ChartModelImpl myChartModel;
    ...
    public void setMyChartModel(ChartModelImpl model) {
        this.myChartModel = model;
    }
...
//        date.setDay(1);
        ...
        Mediator.getCustomColumnsManager().addCustomColumnsListener(this);
        myTaskImageGenerator = new TaskTreeImageGenerator(ttree,
            app.getUIConfiguration());
    }
    ...
    public GanttGraphicArea(GanttProject app, GanttTree2 ttree,
                            TaskManager taskManager, ZoomManager zoomManager,
                            GPUndoManager undoManager, Object root,
        ...
        myUndoManager = undoManager;
        //
        myChartModel = new WitsGanttChartModel(getTaskManager(), app
                                               .getTimeUnitStack(),
                                               app.getUIConfiguration(), root,
                                               configs, treeColumnName);
        myChartModel.addOptionChangeListener(new GPOptionChangeListener() {
            public void optionsChanged() {
                repaint();
...
//        date.setDay(1);
    ...
    public Color getTaskColor() {
        ...
        return myProjectLevelTaskColor == null ? myUIConfiguration
            .getTaskColor() : myProjectLevelTaskColor;
    ...
    public BufferedImage getChart(GanttExportSettings settings) {
        RenderedChartImage renderedImage = (RenderedChartImage)
                                           getRenderedImage(settings);
    ...
    public RenderedImage getRenderedImage(GanttExportSettings settings) {
        ...
        List myItemsToConsider = myTaskImageGenerator.getPrintableNodes(
            settings);
        ...
        TaskLength printedLength = getTaskManager().createLength(unit,
            dateStart, dateEnd);
        BufferedImage taskImage = (BufferedImage) myTaskImageGenerator.
                                  createImage(myItemsToConsider);
        ...
        return new RenderedGanttChartImage(myChartModel, myChartComponentImpl,
                                           GanttTree2.
                                           convertNodesListToItemList(
                                               myItemsToConsider), taskImage,
...
//                                         + HEADER_OFFSET);
            myChartModel.setHeaderHeight(40);
    ...
    class ChangeTaskEndInteraction extends ChangeTaskBoundaryInteraction implements
        MouseInteraction {
    ...
    class ChangeTaskStartInteraction extends ChangeTaskBoundaryInteraction implements
        MouseInteraction {
        ...
        protected void apply(float diff) {
            ...
            if (dayDiff != 0) {
                ...
                if ((getTask().getThird() != null)
                    &&
                    (getTask().getThirdDateConstraint() ==
                     TaskImpl.EARLIESTBEGIN)) {
    ...
    private class NewChartComponentImpl extends ChartImplementationBase implements
        ChartImplementation {
        ...
        public void paintComponent(Graphics g) {
            synchronized (ChartModelBase.STATIC_MUTEX) {
                ...
                model.setVerticalOffset(getScrollBar() %
                                        tree.getTreeTable().getRowHeight());
                model.paint(g);
                if (getActiveInteraction() != null) {
                    getActiveInteraction().paint(g);
                }
        ...
        private OldChartMouseListenerImpl myMouseListener = new
            OldChartMouseListenerImpl();

        private OldMouseMotionListenerImpl myMouseMotionListener = new
            OldMouseMotionListenerImpl();
    ...
    public Action getScrollCenterAction(ScrollingManager scrollMgr,
                                        TaskSelectionManager taskSelMgr,
                                        String iconSize) {
    ...
    protected class ScrollGanttChartCenterAction extends GPAction {
        ...
        public void actionPerformed(ActionEvent e) {
            getUIFacade().setStatusText(GanttLanguage.getInstance().getText(
        ...
        public void mouseClicked(MouseEvent e) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                Task taskUnderPointer = myMouseSupport
                                        .findTaskUnderMousePointer(e.getX(),
                    e.getY());
...
//            return result;
        ...
        public void mousePressed(MouseEvent e) {
            ...
            Task taskUnderPointer = myMouseSupport.findTaskUnderMousePointer(e
                .getX(), e.getY());
            if (taskUnderPointer != null &&
                !Mediator.getTaskSelectionManager().isTaskSelected(
                    taskUnderPointer)) {
                boolean ctrl = (e.getModifiersEx() & InputEvent.CTRL_DOWN_MASK) ==
...
//                                           .getChartItemUnderMousePoint(e.getX(),
//                        e.getY());
//                if (itemUnderPoint instanceof TaskBoundaryChartItem) {
//                    //去掉改变任务时间拖动的相关操作
////                    TaskBoundaryChartItem taskBoundary = (TaskBoundaryChartItem)
////                            itemUnderPoint;
////                    if (taskBoundary.isStartBoundary()) {
////                        getChartImplementation()
////                                .beginChangeTaskStartInteraction(e,
////                                taskBoundary);
////                    } else {
////                        getChartImplementation().beginChangeTaskEndInteraction(
////                                e, taskBoundary);
////                    }
//                } else if (itemUnderPoint instanceof TaskProgressChartItem) {
//                    //去掉拖动进度的相关操作
////                    getChartImplementation()
////                            .beginChangeTaskProgressInteraction(e,
////                            (TaskProgressChartItem) itemUnderPoint);
//
//                } else if (itemUnderPoint instanceof TaskRegularAreaChartItem) {
//                    getChartImplementation().beginDrawDependencyInteraction(e,
//                            (TaskRegularAreaChartItem) itemUnderPoint,
//                            myMouseSupport);
//                }
//                repaint();
