...
public class TaskRendererImpl extends ChartRendererBase implements
        TimeUnitVisitor, CustomColumsListener {
    ...
    private List/* <Task> */getSortedTaskActivities() {
        ...
        for (int i = 0; i < visibleTasks.size(); i++) {
            ...
            float totalTaskLength = nextTask.getDuration().getLength(
...
//        posX += deltaX;
    ...
    public void customColumsChange(CustomColumEvent event) {
        ...
        if (type == CustomColumEvent.EVENT_ADD)
            addOption(event.getColName());
        else if (type == CustomColumEvent.EVENT_REMOVE)
