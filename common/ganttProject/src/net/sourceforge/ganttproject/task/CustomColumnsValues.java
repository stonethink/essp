...
public class CustomColumnsValues implements Cloneable {
     ...
     */
    private Map mapCustomColumnValue = null;

    /**
     * Creates an instance of CustomColumnsValues.
     */
    public CustomColumnsValues() {
        mapCustomColumnValue = new HashMap();
    }
    ...
    public void setValue(String customColName, Object value)
        ...
        Class c1 = Mediator.getCustomColumnsStorage().getCustomColumn(
                customColName).getType();
