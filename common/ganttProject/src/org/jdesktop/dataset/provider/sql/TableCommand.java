/*
 * $Id: TableCommand.java,v 1.1 2006/10/10 03:50:56 mingxingzhang Exp $
 *
...
/**
 * A simplified DataCommand for use with an SQLDataProvider. This DataCommand
 * is based on selecting all of the columns in a given table. No joins are used.
 * Because this is a simple table based DataCommand, it can infer the insert,
 * update, and delete SQL statements to use.
 * <p>
 * If you need explicit select, insert, update, or delete DataCommands, use
 * SelectCommand, InsertCommand, UpdateCommand or DeleteCommand, respectively.
 *
 * @author rbair
 */
...
//
    ...
    protected PreparedStatement getUpdateStatement(JDBCDataConnection conn, DataRow row) throws Exception {
        //XXX TODO SHOWSTOPPER!!! This SQL needs to be much, much more robust. Only the changed values
        ...
        try {
            ...
            buffer.append(tableName);
            buffer.append(" set ");
            //iterate over all of the columns in the row, adding them all in here
    ...
    protected PreparedStatement getDeleteStatement(JDBCDataConnection conn, DataRow row) throws Exception {
        //XXX TODO SHOWSTOPPER!!! The keycolumns are never set as the basis for the delete!!!
