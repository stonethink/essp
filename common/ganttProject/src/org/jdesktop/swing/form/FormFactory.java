/*
 * $Id: FormFactory.java,v 1.1 2006/10/10 03:51:01 mingxingzhang Exp $
 *
...
public abstract class FormFactory {
     ...
     *         object or null if the field is non-visual.
     */
    ...
    public boolean isNonVisual(MetaData metaData) {
        return Boolean.TRUE
          .equals(metaData.getCustomProperty(DataConstants.NON_VISUAL_FIELD));
      }
