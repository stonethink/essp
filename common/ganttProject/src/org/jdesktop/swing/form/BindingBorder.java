/*
 * $Id: BindingBorder.java,v 1.1 2006/10/10 03:51:01 mingxingzhang Exp $
 *
...
public class BindingBorder
    ...
    public void paintBorder(Component c, Graphics g, int x, int y,
        ...
        if (!isMessageBoxShowing()) {
            ...
            } else if (iconPosition == SwingUtilities.EAST){ // EAST
                validIconBounds.y = y +
                     ((height - validIcon.getIconHeight())/2);
            } else if (iconPosition == SwingUtilities.WEST) {
              validIconBounds.y = y +
              ((height - validIcon.getIconHeight())/2);
              validIconBounds.x = x + width - PAD - requiredIconSpace -
              validIcon.getIconWidth();
