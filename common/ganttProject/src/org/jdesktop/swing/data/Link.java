/*
 * $Id: Link.java,v 1.1 2006/10/10 03:51:00 mingxingzhang Exp $
 *
...
/**
 * An object which represents an URL link in a table cell, tree cell or
 * list item.
 *
...
public class Link implements Comparable  {
     ...
     * @param template a string that represents a URL with @{N} place holders
    ...
    /**
     * Create a URL from a template string that has place holders and
     * an array of strings which will be substituted into the place holders.
     * The place holders are represented as @{N} where N = { 1..n }
     * <p>
     * For example, if the template contains a string like:
     *    http://bugz.sfbay/cgi-bin/showbug?cat=@{1}&sub_cat=@{2}
     * and a two arg array contains:
     *    java, classes_swing
    ...
    /**
     * Set the target that the URL should load into. This can be a
     * uri representing another control or the name of a window or
     * special targets. See:
     * http://www.w3c.org/TR/html401/present/frames.html#adef-target
     */
    ...
    /**
     * Sets a flag to indicate if the link has been visited. The state
     * of this flag can be used to render the color of the link.
     */
