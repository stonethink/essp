/*
 * $Id: JNForm.java,v 1.1 2006/10/10 03:50:53 mingxingzhang Exp $
 *
...
public class JNForm extends JNComponent {
     ...
     */
    public void bind(DefaultTableModelExt tabularData) throws BindException {
     ...
     * @throws BindException if there were errors when binding to the data model
     */
    public void bind(DefaultTableModelExt tabularData, String columnName) throws BindException {
