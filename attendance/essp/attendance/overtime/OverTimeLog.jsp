...
<%@ page import="server.essp.attendance.overtime.viewbean.VbOverTimeReviewLog" %>
<%@page import="itf.hr.HrFactory"%>
<html>
<head>
<tiles:insert page="/layout/head.jsp">
  <tiles:put name="title" value="OverTimeLog"/>
  <tiles:put name="jspName" value="OverTimeLog"/>
</tiles:insert>
...
<body >
    <html:tabpanel id="OverTimeLogList" width="522">
        <%-- card title--%>
        <html:tabtitles>
        ...
        <html:tabcontents>
            <html:tabcontent styleClass="wind">
                <html:outborder height="25%" width="522">
                         ...
                         <html:tablebody styleId="tableDataStyle" height="80" id="searchTable">
                           <logic:present name="webVo">
                             <logic:iterate id="log" name="webVo" indexId="indexId">
                               <%
                               VbOverTimeReviewLog reviewLog = (VbOverTimeReviewLog)log;
                               %>
                               <html:tablerow
