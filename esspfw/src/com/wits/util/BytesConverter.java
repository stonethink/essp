...
public class BytesConverter {
    ...
    //private static Hashtable htConverter = new Hashtable();
/*
	private static String ConvertInDbFrom = null;
	private static String ConvertInDbTo = null;
	private static String ConvertOutDbFrom = null;
	private static String ConvertOutDbTo = null;
*/
	...
	public String convertOutDb(String strIn){
		...
		log.debug("strIn ="+ strIn + ";cvtFrom =" + cvtFrom + ";cvtTo =" + cvtTo);
