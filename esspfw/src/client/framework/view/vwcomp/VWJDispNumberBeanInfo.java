 ...
 * @version 1.0
 */
public class VWJDispNumberBeanInfo extends SimpleBeanInfo {
    Class beanClass = VWJDispNumber.class;
    String iconColor16x16Filename;
    String iconColor32x32Filename = "DispNumber32.GIF";
    String iconMono16x16Filename;
    String iconMono32x32Filename = "DispNumber32.GIF";

    public VWJDispNumberBeanInfo() {
    }
