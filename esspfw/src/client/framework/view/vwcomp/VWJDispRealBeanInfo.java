 ...
 * @version 1.0
 */
public class VWJDispRealBeanInfo extends SimpleBeanInfo {
    Class beanClass = VWJDispReal.class;
    String iconColor16x16Filename;
    String iconColor32x32Filename = "DispDoublee32.GIF";
    String iconMono16x16Filename;
    String iconMono32x32Filename = "DispDoublee32.GIF";

    public VWJDispRealBeanInfo() {
    }
