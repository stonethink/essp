...
public class VWJTreeTableEditor extends AbstractCellEditor implements
    TableCellEditor {
    ...
    public VWJTreeTableEditor(Component comp, JTreeTable treeTable) {
        this.comp = comp;
...
//  from the CellEditor interface to our delegate.
    ...
    public boolean isCellEditable(EventObject anEvent) {
        ...
        if (anEvent instanceof MouseEvent) {
            ...
            row = me.getY() / this.treeTable.getRowHeight();
