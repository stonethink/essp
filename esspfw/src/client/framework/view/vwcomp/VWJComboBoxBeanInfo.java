 ...
 * @version 1.0
 */
public class VWJComboBoxBeanInfo extends SimpleBeanInfo {
    Class beanClass = VWJComboBox.class;
    String iconColor16x16Filename;
    String iconColor32x32Filename = "Combo32.gif";
    String iconMono16x16Filename;
    String iconMono32x32Filename = "Combo32.gif";

    public VWJComboBoxBeanInfo() {
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor _VMComboBox = new PropertyDescriptor(
                "VMComboBox", beanClass, "getVMComboBox", "setVMComboBox");
