...
public class JMsDispDateBeanInfo extends SimpleBeanInfo {
	Class beanClass = JMsDispDate.class;
	String iconColor16x16Filename = "DispDate32.GIF";
	String iconColor32x32Filename = "DispDate32.GIF";
	String iconMono16x16Filename;
	String iconMono32x32Filename;

	public JMsDispDateBeanInfo() {
	}
