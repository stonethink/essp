...
import client.framework.common.treeTable.AbstractTreeTableModel;
import client.framework.common.treeTable.TreeTableModel;
import org.apache.log4j.Category;
import java.lang.reflect.Method;

public class VMTreeTableModel extends AbstractTreeTableModel implements
        IColumnConfig {
...
//  List rows = new ArrayList();
    ...
    //The column named treeColumnName will be rendered as a tree.
    //The first column is the default tree column.
    //@see getColumnClass().
    ...
    public VMTreeTableModel(ITreeNode root) {
        super(root);
//        this.root = treeNode;
    }

//  public VMTTreeTable(Object[][] configs) {
//    setColumnConfigs(configs);
//  }

    public VMTreeTableModel(ITreeNode treeNode, Object[][] configs) {
        this(treeNode);
        setColumnConfigs(configs);
//        this.root = treeNode;
        //setRows(dtoList);
