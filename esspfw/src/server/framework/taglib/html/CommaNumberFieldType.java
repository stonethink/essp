...
public class CommaNumberFieldType extends AbstractFieldType
{

    public CommaNumberFieldType()
    {
    }
    ...
    {
        StringBuffer sbuf = new StringBuffer(" Mtext");
