...
<table class="OraTable" summary="">
  ...
  <tbody>
    ...
    <tr id="workplan_tr" class="oracletdone">
      <td id="Account" class="cellText" width="18%">
          <logic:present name="exception" property="errorCode">
          <bean:write name="exception" property="errorCode"/>
          </logic:present>
      </td>
      <td id="Activity" class="cellText" width="*">
          <logic:present name="exception" property="errorMsg">
          <bean:write name="exception" property="errorMsg"/>
          </logic:present>
          <logic:notPresent name="exception" property="errorMsg">
              <bean:define id="exception" name="exception"/>
              <%
