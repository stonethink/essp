...
<head>
	<tiles:insert page="/layout/head.jsp">
		<tiles:put name="title" value="Update Issue Category"/>
...
function onSaveData() {
    if(!submitForm(issueCategoryForm)) {
        ...
        opener.dataForm.action="<%=contextPath%>/issue/typedefine/category/categoryUpdateAction.do";
...
<body>
    ...
    <br />
    <html:form action="/issue/typedefine/category/categoryUpdateAction"  onsubmit="return submitForm(this);">
    ...
    <table bgcolor="ffffff" cellpadding="1" cellspacing="1" border="0" align="center">
        <tr>
            ...
            <td class="list_range" width="160">
               <html:text beanName="webVo" name="categoryName" fieldtype="text" styleId="input_common" next="sequence"   readonly="true" req="true" maxlength="100"/>
            </td>
            <td class="list_range" width="70">Sequence</td>
