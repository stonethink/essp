...
<head>
	<tiles:insert page="/layout/head.jsp">
		<tiles:put name="title" value="Add Issue Category Value"/>
...
function onSaveData() {
    if(!submitForm(issueCategoryValueForm)) {
        ...
        opener.dataForm.action="<%=contextPath%>/issue/typedefine/category/categoryValueAddAction.do";
...
<body>
    ...
    <br />
    <html:form action="/issue/typedefine/category/categoryValueAddAction"  onsubmit="return submitForm(this);">
    <table bgcolor="ffffff" cellpadding="1" cellspacing="1" border="0" align="center">
        ...
        <tr>
            ...
            <td class="list_range" width="90">
                 <html:text beanName="" name="categoryValue" fieldtype="text" styleId="input_common" next="sequence"  prev="categoryName"  req="true" maxlength="100"/>
            </td>
        </tr>
        <tr>
