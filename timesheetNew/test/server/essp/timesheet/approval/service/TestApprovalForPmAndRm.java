 ...
 * @version 1.0
 */
public class TestApprovalForPmAndRm extends TestCase {
...
static{
    ...
    List laborString = new ArrayList();
    laborString.add("WH0607015");
    dataMap.put("laborString", laborString);
    ...
    tsDetail.setJobDescription("testdesc");
    tsDetail.setRid(Long.valueOf(1));
    tsDetail.setStatus(DtoTimeSheet.STATUS_RM_APPROVED);
    tsDetail.setTsRid(Long.valueOf(1));
    detailList.add(tsDetail);
    ...
    tsParameter.setTsApprovalLevel(DtoPreference.APPROVAL_LEVEL_PM_AND_RM);
    ...
    public void setUp() throws Exception {
        ...
        expect(preferenceDaoMock.loadPreference()).andReturn((TsParameter) dataMap.
                get("tsParameter"));
   ...
   public void testPmApproval_Normal(){
       ...
       expect(timeSheetDaoMock.listTimeSheetDetailByAcntRidTsRidByStatus(Long.valueOf(1),
               Long.valueOf(1), "('" + DtoTimeSheet.STATUS_SUBMITTED
                 + "','" + DtoTimeSheet.STATUS_RM_APPROVED + "')"))
               .andReturn((List)dataMap.get("detailListOne"));
       timeSheetDaoMock.updateTimeSheetDetailStatus(Long.valueOf(1), DtoTimeSheet.STATUS_PM_APPROVED);
       expectLastCall().anyTimes();
       expect(timeSheetDaoMock.listTimeSheetDetailNotEqualsStatusByTsRid(Long.valueOf(1),
               DtoTimeSheet.STATUS_PM_APPROVED)).andReturn(null);
       timeSheetDaoMock.updateTimeSheetMasterStatus(Long.valueOf(1), DtoTimeSheet.STATUS_PM_APPROVED);
       expectLastCall().anyTimes();
       List list = new ArrayList();
       TsTimesheetDetail tsDetail = new TsTimesheetDetail();
       list.add(tsDetail);
       expect(timeSheetDaoMock.listTimeSheetDetailNotEqualsStatusByTsRid(Long.valueOf(1),
               DtoTimeSheet.STATUS_APPROVED)).andReturn(list);
   ...
   public void testRmList_Normal() throws Exception {
      ...
      public void testRmApproval_Normal(){
        ...
        expect(timeSheetDaoMock.listTimeSheetDetailByTsRidStatus(
                ...
                .andReturn((List)dataMap.get("detailListOne"));
        timeSheetDaoMock.updateTimeSheetDetailStatus(Long.valueOf(1), DtoTimeSheet.STATUS_RM_APPROVED);
        expectLastCall().anyTimes();
        List list = new ArrayList();
        TsTimesheetDetail tsDetail = new TsTimesheetDetail();
        list.add(tsDetail);
        expect(timeSheetDaoMock.listTimeSheetDetailNotEqualsStatusByTsRid(Long.valueOf(1),
                DtoTimeSheet.STATUS_RM_APPROVED)).andReturn(list);
        expect(timeSheetDaoMock.listTimeSheetDetailNotEqualsStatusByTsRid(Long.valueOf(1),
                DtoTimeSheet.STATUS_APPROVED)).andReturn(list);
