 ...
 * @version 1.0
 */
public class TsReportExporter extends ExcelExporter {
    public static final String TEMPLATE_FILE = "Template_TsDetailReport.xls";//模板文件名
    public static final String OUT_FILE = "TimeSheet Detail Report.xls";//导出文件名

    //Sheet名称
    public static final String SHEEET_RESULT = "TimeSheetDetail";
    public TsReportExporter() {
        super(TEMPLATE_FILE, OUT_FILE);
    }

    public TsReportExporter(String outFile) {
        super(TEMPLATE_FILE, outFile);
    }
     public void doExport(Parameter inputData) throws Exception {
        List list = (List) inputData.get(DtoTsDetailReport.DTO_QUERY_RESULT);
