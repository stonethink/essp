...
/**
 * <p>Description:ÏÔÊ¾RelationDetailµÄAction </p>
 ...
 * @version 1.0
 */
public class AcShowRelationDetail extends AbstractESSPAction{
    public void executeAct(HttpServletRequest request, HttpServletResponse response,
       ...
       Long activityObjId = (Long)inputInfo.getInputObj(DtoActivityKey.DTO_RID);
       returnInfo.setReturnObj(DtoActivityKey.DTO_RELATION_DETAIL, lg.getRelationDetail(activityObjId));
 }
}
