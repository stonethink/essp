 ...
 * @version 1.0
 */
public class VwTsStatus extends VWTDWorkArea{
        private static final String actionIdExporter = "FTSStatusExporter";
        private VwTsStatusUp vwUp = new VwTsStatusUp();
        ...
        private VwFillRateBySiteDown vwFillRateDown = new VwFillRateBySiteDown();
        ...
        protected void jbInit() throws Exception {
            ...
            this.getTopArea().addTab("rsid.timesheet.tsReportStatusSiteQuery",vwUp);
        }
        ...
        protected void processExport() {
            ...
            param.put(DtoTsStatusQuery.DTO_IS_DEPT_QUERY,"false");
            param.put(DtoTsStatusQuery.DTO_DEPT_ID,null);
            param.put(DtoTsStatusQuery.DTO_INCLUDE_SUB,null);
            param.put(DtoTsStatusQuery.DTO_SITE,site);
        ...
        protected void actionPerformedQuery(ActionEvent e) {
                ...
                if(!flag){
                  ...
                  if(resultMap != null){  
                      ...
                      List fillRateList = (List) resultMap.get(DtoTsStatusQuery.DTO_FILLED_RATE);
                      if(fillRateList != null){
                          param.put(DtoTsStatusQuery.DTO_RESULT_LIST, fillRateList);
                          vwFillRateDown = new VwFillRateBySiteDown();
                          vwFillRateDown.setParameter(param);
                          downArea.addTab(newTitle,vwFillRateDown);
                          vwFillRateDown.refreshWorkArea();  
                      }
