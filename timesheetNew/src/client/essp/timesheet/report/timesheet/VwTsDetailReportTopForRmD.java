 ...
 * @version 1.0
 */
public class VwTsDetailReportTopForRmD extends VwTsDetailReportTopBase{
    ...
    public VwTsDetailReportTopForRmD() {
        jbInit();
        addUICEvent();
    }
    protected void jbInit() {
        ...
        private void processDeptSelected() {
         ...
         protected DtoQueryCondition getDtoQueryCondition() {
             ...
             dtoQueryCondition.setQueryWay(DtoQueryCondition.DTO_QUERY_WAY_RM);
