...
<html>
  <head>
  	<title><bean:message bundle="projectpre" key="projectCode.BDCodeSetting" /></title>
  ...
  <body>
  <html:form  id="BdCode" method="post" action="/project/maintenance/addBdCode" onsubmit="return checkReq(this)" initialForcus="bdCode">
   <table align=center><td class="list_range"></td></table>
  <table id="Table1" cellSpacing="0" cellPadding="0" align="center" width="400" border="0" style="padding-left:8px">
  <tr>
