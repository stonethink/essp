     ...
     function onAddData(){
       ...
       if(rows.length > 0) {
         ...
         if(confirm("<bean:message bundle="application" key="global.confirm.delete"/>")) {
    	  window.location="<%=contextPath%>/project/mail/deleteMailPrivilege.do?loginId="+currentRow.selfproperty;
          }
		}
...
<body >
          ...
          action="${pageContext.request.contextPath}/project/mail/listUserList.do"
