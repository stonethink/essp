...
<html>
     ...
     function onSaveData(){
      ...
      function refreshUp(){
           try{
        	...
        	//alert(status);
        	var code="<bean:write name="webVo" property="code"  scope="request"/>";
        	if(code==null)return;
  ...
  <body style="padding-left:8px">
    ...
    <html:form  id="TypeCodeUpdateForm" method="post" action="/parameter/updateParameter.do">
  ...
  <tr>
    ...
    <td class="list_range"><html:text styleId="input_field" fieldtype="text" fmt="8.0" req="true" name="sequence" fieldtype="number" beanName="webVo" maxlength="4"/></td>
    <td class="list_range">&nbsp;</td>
  </tr>
  <tr>
    <td class="list_range"><bean:message bundle="projectpre" key="projectCode.Desc"/></td>
    <td class="list_range" colspan="2">
    <html:textarea name="description" beanName="webVo" rows="4" styleId="desc" req="false" maxlength="250"  />
    </td>
  </tr>
  <tr>
