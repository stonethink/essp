     ...
     function onAddData(){
       ...
       if(rows.length > 0) {
         ...
         if(confirm("<bean:message bundle="application" key="global.confirm.delete"/>")) {
    	  window.location="<%=contextPath%>/mailprivilege/deletePrivilege.do?LoginId="+currentRow.selfproperty;
          }
		}
         ...
         function autoClickFirstRow(){
            ...
            var str0 = "<bean:message bundle="projectpre" key="projectCode.MailPrivilege.userId"/>";
            var str1 = "<bean:message bundle="projectpre" key="projectCode.MailPrivilege.userName"/>";
            var str2 = "<bean:message bundle="projectpre" key="projectCode.MailPrivilege.domain"/>";
...
<body >
          ...
          action="${pageContext.request.contextPath}/mailprivilege/userList.do"
