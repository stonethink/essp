...
<%String actionSrc_TemplateDetail = "";
			actionSrc_TemplateDetail = contextPath
					+ "/timesheet/template/templateDetail.jsp";%>
					...
					<html:tabpanel id="tabDetail" onchange="onTabChange()" width="100%">
						<html:tabtitles selectedindex="1">
							...
							<html:tabtitle width="120">
								<span class="tabs_title"><bean:message key="timesheet.template.template" bundle="timesheet"/></span>
							</html:tabtitle>
						</html:tabtitles>
						<html:tabbuttons>
							<div id="btnPanel">
						...
						<html:tabcontents>
							...
							<html:tabcontent>
								<html:outborder width="100%" height="100%" outLine="no">
									<IFRAME id="templateDetail"
									 name="templateDetail" 
									 SRC="<%=actionSrc_TemplateDetail%>" 
