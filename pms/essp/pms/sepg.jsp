...
<object
    ...
    <PARAM NAME = "entryFunType" VALUE="<%=c2s.essp.pms.account.DtoAcntKEY.SEPG_ACCOUNT_FUN%>">
	...
	<embed
            ...
            userName ="<%=userName%>" \
            userType ="<%=userType%>" \
            entryFunType ="<%=c2s.essp.pms.account.DtoAcntKEY.SEPG_ACCOUNT_FUN%>"
	    scriptable = false
...
<!--
<APPLET CODE = "client.essp.common.view.VWJMultiApplet" ARCHIVE = "<%=appletDir%>/pms_client.jar,<%=appletDir%>/wp_client.jar,<%=appletDir%>/ganttProject_withDepends.jar,<%=appletDir%>/tc_client.jar,<%=comJar%>" WIDTH = "100%" HEIGHT = "100%" NAME = "Account" ALIGN = "middle" VSPACE = "0" HSPACE = "0">
<PARAM NAME = "cfg" VALUE="pmsAppletCfg">
<PARAM NAME = "controllerURL" VALUE="<%=controllerURL%>">
<PARAM NAME = "todayDate" VALUE="<%=todayDate%>">
<PARAM NAME = "todayDatePattern" VALUE="<%=todayDatePattern%>">
