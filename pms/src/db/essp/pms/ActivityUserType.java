...
public class ActivityUserType implements CompositeUserType {
    private String[] propertyNames = new String[] {"acntRid", "activityId"};
    private Type[] propertyTypes = new Type[] {Hibernate.LONG, Hibernate.LONG};

    public ActivityUserType() {
    }
    ...
    public Object deepCopy(Object value) throws HibernateException {
        ...
        ActivityPK pk=(ActivityPK)value;
        return new ActivityPK(pk.getAcntRid(),pk.getActivityId());
    }
    ...
    public boolean equals(Object x, Object y) throws HibernateException {
        ...
        if(x instanceof ActivityPK && y instanceof ActivityPK) {
            return x.equals(y);
        }
        return false;
    }
    ...
    public Object getPropertyValue(Object component, int property) throws
        HibernateException {
        ActivityPK pk = (ActivityPK) component;
        Long result;
        switch (property) {
        case 0:
    ...
    public Object nullSafeGet(ResultSet rs, String[] names,
        ...
        try {
            ...
            String activityIdStr = rs.getString(names[1]);
            if(acntRidStr!=null && activityIdStr!=null) {
                Long acntRid=new Long(acntRidStr);
                Long activityId=new Long(activityIdStr);
                return new ActivityPK(acntRid, activityId);
            }
            return null;
        } catch(Exception e) {
            //e.printStackTrace();
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index,
        ...
        if(value==null) {
            ...
            ActivityPK pk=(ActivityPK)value;
            if(pk.getAcntRid()!=null && pk.getActivityId()!=null) {
                st.setLong(index, pk.getAcntRid().longValue());
                st.setLong(index + 1, pk.getActivityId().longValue());
            } else {
                st.setNull(index,Types.INTEGER);
                st.setNull(index+1,Types.INTEGER);
            }
