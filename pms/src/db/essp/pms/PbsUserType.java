...
public class PbsUserType implements CompositeUserType {
    private String[] propertyNames = new String[] {"acntRid", "pbsRid"};
    ...
    public Object deepCopy(Object value) throws HibernateException {
        ...
        PbsPK pk=(PbsPK)value;
        return new PbsPK(pk.getAcntRid(),pk.getPbsRid());
    }
    ...
    public boolean equals(Object x, Object y) throws HibernateException {
        ...
        if(x instanceof PbsPK && y instanceof PbsPK) {
            return x.equals(y);
        }
        return false;
    }
    ...
    public Object nullSafeGet(ResultSet rs, String[] names,
        ...
        try {
            ...
            String pbsRidStr = rs.getString(names[1]);
            if(acntRidStr!=null && pbsRidStr!=null) {
                Long acntRid=new Long(acntRidStr);
                Long pbsRid=new Long(pbsRidStr);
                return new PbsPK(acntRid, pbsRid);
            }
            return null;
        } catch(Exception e) {
            //e.printStackTrace();
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index,
        ...
        if(value==null) {
            ...
            PbsPK pk=(PbsPK)value;
            if(pk.getAcntRid()!=null && pk.getPbsRid()!=null) {
                st.setLong(index, pk.getAcntRid().longValue());
                st.setLong(index + 1, pk.getPbsRid().longValue());
            } else {
                st.setNull(index,Types.INTEGER);
                st.setNull(index+1,Types.INTEGER);
            }
