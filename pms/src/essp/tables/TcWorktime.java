 ...
 *     
*/
public class TcWorktime implements Serializable {
    ...
    /** full constructor */
    public TcWorktime(Long rid, String wtStarttime, String wtEndtime, String rst, Date rut, Date rct) {
        this.rid = rid;
    ...
    /** minimal constructor */
    public TcWorktime(Long rid, String wtStarttime, String wtEndtime, Date rut, Date rct) {
        this.rid = rid;
        this.wtStarttime = wtStarttime;
        this.wtEndtime = wtEndtime;
        this.rut = rut;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TcWorktime) ) return false;
        TcWorktime castOther = (TcWorktime) other;
