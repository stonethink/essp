...
public class VbTcExcel implements ICellStyleAware{
   ...
   private Date beginDateOfWork;//工作起日
   private Date endDateOfWork;//工作止日
   ...
   private String wmReportStatus;//周月报状态(记录未填写或未锁定或未被确认的周报信息)
   private String attendanceReportStatus;//差情的状态(记录未审核的加班请假信息)
