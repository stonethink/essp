...
public class AcActivityRelationLoad extends AbstractESSPAction {
    /**
     * executeAct
     *
    ...
    public void executeAct(HttpServletRequest request,
        ...
        List acountAllRelation = logic.listRelationsByAccount(acntRid);
        returnInfo.setReturnObj("accountAllRelation",acountAllRelation);
    }
}
