...
public class FTC01030Applet extends VWJApplet implements IVWAppletParameter{
    private boolean      isStandalone = false;
    private FTC01030Main fTC01030Main;

    //Construct the applet
    public FTC01030Applet() {
        try {
    ...
    private void jbInit() throws Exception {
        ...
        fTC01030Main.setRefreshFlag(true);
        fTC01030Main.refreshWorkArea();
        this.getContentPane().add(fTC01030Main, BorderLayout.CENTER);
    }
    ...
    public static void main(String[] args) {
        FTC01030Applet applet = new FTC01030Applet();
