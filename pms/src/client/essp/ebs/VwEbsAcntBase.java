 ...
 * @version 1.0
 */
public class VwEbsAcntBase extends VWGeneralWorkArea {
    ...
    //VWJButton btnAcntManager = new VWJButton();
    ...
    private void jbInit() throws Exception {
        this.setLayout(null);
        this.setPreferredSize(new Dimension(750,280));
    ...
    public static void main(String args[]) {
        TestPanelParam.show(new VwEbsAcntBase());
    }
