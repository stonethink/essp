 ...
 * @version 1.0
 */
public class VwBLPlanFilter extends VWWorkArea implements IVWPopupEditorEvent {
    public VwBLPlanFilter() {
        try {
            jbInit();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public VwBLPlanFilter(VWJTreeTable table, VwBLPlanList planList,
    ...
    public void init() {
        ...
        VMComboBox conditionSelModel = VMComboBox.toVMComboBox(VwBLPlanFilter.
            FILTER_CONDITION, VwBLPlanFilter.FILTER_CONDITION);
