...
public class VwBLMonitoringList extends VWTreeTableWorkAreaForBL implements
    IVariantListener {
...
//    private static final String ACTIONID_UPDATEFORWBS = "FWbsUpdateAction";
    ...
    public VwBLMonitoringList(VWJLabel filterLbl, VWAccountLabel accountLabel) {
        this();
    ...
    public VwBLMonitoringList() {
        try {
            ...
            configs = new Object[][] { {"Name", "name",
                      ...
                      {"Actual Start", "actualStart", VMColumnConfig.EDITABLE,
                      planDate}, {"Actual Finish", "actualFinish",
                      VMColumnConfig.EDITABLE, planDate}, {"Weight", "weight",
            ...
            tcModel.getColumn(6).setPreferredWidth(30);
            tcModel.getColumn(7).setPreferredWidth(40);
            tcModel.getColumn(8).setPreferredWidth(100);
...
//                    "This wbs has not been saved.Cannot add a new wbs to this wbs.");
            ...
            inputInfo.setActionId(VwBLMonitoringList.ACTIONID_GETRID);
...
//                    "This wbs has not been saved.Cannot add a new activity to this wbs.");
            ...
            InputInfo inputInfo = new InputInfo();
            inputInfo.setInputObj(DtoKEY.DTO, dataBean);
            inputInfo.setActionId(VwBLMonitoringList.ACTIONID_GETCODE);
    ...
    public void actionPerformedDelete(ActionEvent e) {
        ...
        if (option == Constant.OK) {
            ...
            if (!dataBean.isInsert()) {
                InputInfo inputInfo = new InputInfo();
                inputInfo.setInputObj(DtoKEY.DTO, dataBean);
                inputInfo.setActionId(VwBLMonitoringList.ACTIONID_DELETE);
...
//        if (option == Constant.OK) {
    ...
    public ReturnInfo actionPerformedSave() {
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_SAVEALL);
    ...
    public void actionPerformedDownForWBS(ActionEvent e) {
        ...
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_DOWNMOVEFORWBS);
    ...
    public void actionPerformedDownForActivity(ActionEvent e) {
        ...
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_DOWNMOVEFORACTIVITY);
        inputInfo.setInputObj(DtoKEY.DTO, node);
        ReturnInfo returnInfo = accessData(inputInfo);
        if (!returnInfo.isError()) {
...
//        DtoWbsTreeNode node = (DtoWbsTreeNode)this.getSelectedNode();
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_UPMOVEFORWBS);
        inputInfo.setInputObj(DtoKEY.DTO, node);
        ReturnInfo returnInfo = accessData(inputInfo);
        if (!returnInfo.isError()) {
    ...
    public void actionPerformedUpForActivity(ActionEvent e) {
        ...
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_UPMOVEFORACTIVITY);
        inputInfo.setInputObj(DtoKEY.DTO, node);
        ReturnInfo returnInfo = accessData(inputInfo);
        if (!returnInfo.isError()) {
            this.getTreeTable().upMove();
    ...
    public void actionPerformedLeftForWBS(ActionEvent e) {
        ...
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_LEFTMOVEFORWBS);
        inputInfo.setInputObj(DtoKEY.DTO, node);
        ReturnInfo returnInfo = accessData(inputInfo);
        if (!returnInfo.isError()) {
    ...
    public void actionPerformedLeftForActivity(ActionEvent e) {
        ...
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_LEFTMOVEFORACTIVITY);
        inputInfo.setInputObj(DtoKEY.DTO, node);
    ...
    public void actionPerformedRightForWBS(ActionEvent e) {
        ...
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_RIGHTMOVEFORWBS);
        inputInfo.setInputObj(DtoKEY.DTO, node);
    ...
    public void actionPerformedRightForActivity(ActionEvent e) {
        ...
        //save this node to db
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_RIGHTMOVEFORACTIVITY);
        inputInfo.setInputObj(DtoKEY.DTO, node);
    ...
    public void actionPerformedCompute(ActionEvent e) {
        InputInfo inputInfo = new InputInfo();
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_COMPUTE);
    ...
    public void reloadData() {
        ...
        inputInfo.setActionId(VwBLMonitoringList.ACTIONID_LIST);
...
//            inputInfoForLabor.setActionId(VwBLMonitoringList.
//                                          ACTIONID_GETACNT_LABOR);
...
//        }
    ...
    protected void resetUI() {
        reloadData();
//        Object wbstree = ProcessVariant.get("monitortree");
//        if (wbstree != null) {
...
//        }
    ...
    protected void fireProcessDataChange() {
        ...
        ProcessVariant.set("monitortree", root);
        ProcessVariant.fireDataChange("monitortree", this);
...
//               DtoWbsTreeNode root =(DtoWbsTreeNode) this.getTreeTable().getTreeTableModel().getRoot();
//               root.setActivityTree(true);
...
//                getTreeTable().addRow(destWbsTreeNode, wbsTreeNode);
    ...
    public static void main(String args[]) {
        ...
        VWWorkArea workArea = new VwBLMonitoringList();
