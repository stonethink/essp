...
public class VwWeeklyReportListOnWeekByDm extends VwWeeklyReportListBase {
    public VwWeeklyReportListOnWeekByDm() {
    ...
    private static Object[][] getConfigs() {
        ...
        Object[][] configs = new Object[][] {
                             ...
                             {"Activity", "activityDisp", VMColumnConfig.UNEDITABLE,text},
                             {"Job Description", "jobDescription", VMColumnConfig.UNEDITABLE, text},
    ...
    public static void main(String args[]) {
        ...
        VWWorkArea workArea = new VwWeeklyReportListOnWeekByDm();
